...
export default function ProjectTrilogySection() {
  ...
  return (
    <section id="trilogy_intro" className="relative w-full h-full flex flex-col justify-center pt-24 pb-28 lg:py-12 overflow-y-auto bg-transparent text-(--foreground)" style={{ WebkitOverflowScrolling: 'touch' }}>
