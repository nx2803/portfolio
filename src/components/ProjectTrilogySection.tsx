...
export default function ProjectTrilogySection() {
  ...
  return (
    <section id="trilogy_intro" className="relative w-full h-full flex flex-col justify-center pt-28 pb-32 lg:pt-36 lg:pb-16 overflow-y-auto lg:overflow-hidden bg-transparent text-(--foreground)" style={{ WebkitOverflowScrolling: 'touch' }}>
